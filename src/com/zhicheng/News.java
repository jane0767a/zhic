 		...
 		try
     	{
 			...
 			else 
 			{
 				...
 				{		
 					...
 					sb.append("<td ><a style=\"color:#3F862E\" target=\"_blank\" href=\"newsFrontDetail.jsp?newsId="+NewsID+"\">details</a></td></tr>");
		...
		try
    	{
			...
			else 
			{
				...
				{		
					...
					sb.append("href=\"javascript:void(0);\"> <span></span> amend </a> ");			
