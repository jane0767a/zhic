...
public class Function {
		...
		try {
			for (int i = 0; i < s1.length; i++) {
				if ((s1[i] == null) || (s1[i].equals(""))
						|| (s1[i].equals(" "))) {
					sb.append("<li> [ " + s2[i] + " ] Can't be empty!");
					OK = false;
				}
			}
			if (OK)
	...
	public String Page(String sPage, ResultSet rs, int intPage, int intPageSize) {
		...
		try {
			...
			if (intRowCount > intPageSize) {
				...
				s = s + "current" + intPage + "page/total" + intPageCount
						+ "page,&nbsp;&nbsp;&nbsp;&nbsp;total" + intRowCount
						+ "records,&nbsp;&nbsp;&nbsp;&nbsp;" + intPageSize + "records/page";
	...
	public String OutError(String s) {
		try {
			...
			sb
					.append("<div align=\"center\" class=\"title\">error page</div></td></tr>\r\n");
			sb
			...
			sb
					.append("<p align=\"left\"><span class=\"info1\">operation error：</span></p><div align=\"left\" class=\"info1\">");
			...
			sb
					.append("<a href=\"#\" onClick=\"javascript:history.go(-1)\">Return</a></div></td></tr></table></td></tr></table><br><br>\r\n");
			return sb.toString();
		} catch (Exception e) {
		}
	...
	public String OutWarn(String s) {
		try {
			...
			sb.append("<div align=\"left\" class=\"info1\">System notice：<br><br>\r\n");
			sb.append("&nbsp;&nbsp;&nbsp;&nbsp;");
			sb.append(s);
			sb.append("</div></td></tr>\r\n");
			sb
			...
			sb
					.append("<input name=\"Submit\" type=\"button\" class=\"button\" value=\"Cancel\" onClick=\"javascript:history.go(-1);\">&nbsp;&nbsp;\r\n");
			sb
					.append("<input name=\"OK\" type=\"hidden\" id=\"OK\" value=\"Yes\">\r\n");
			sb
					.append("<input name=\"Submit2\" type=\"submit\" class=\"button\" value=\"Confirm\">\r\n");
			sb.append("</div></td>\r\n");
