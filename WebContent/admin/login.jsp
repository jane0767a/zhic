		...
		if (methon.equals("POST") && Page2.equals(Page1))
		{
			try{
				...
				if (login.LoginCheck(User,Pwd))
				{
					...
					out.println("<SCRIPT LANGUAGE='JavaScript'>alert('Login successfully！');location.href='news.jsp';</SCRIPT>");
					return;
				}
				else 
				{
					out.println("<SCRIPT LANGUAGE='JavaScript'>alert('Username or password is not correct！');location.href='login.jsp';</SCRIPT>");
					
					return;
				}
			}catch(Exception e){
				out.println("<SCRIPT LANGUAGE='JavaScript'>alert('Server has a error！!');location.href='login.jsp';</SCRIPT>");
					return;
					}
		}
		else
		{
			response.sendError(403,"Block access to it.");
			return;
		}
	}
%>
		...
		<div class="am-g">
			<div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
				<form action="login.jsp" method="post" class="am-form login-form" onSubmit="return LoginCheck()">
					...
					<input type="submit" value="Login" id="save"	class="am-btn am-btn-primary am-btn-sm am-fl">
